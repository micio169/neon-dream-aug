...
2. **독립형 G-Coin 충전소:** 스팀 월렛 잔액을 소모하여 고정 달러 단가($1.00 = ₩1,515 환산 - 26/06/17 기준) 기준으로 지코인 패키지를 구매할 수 있습니다.
...
## 📝 라이선스 및 비고
- Developed by **micio**.
- 따로 코드를 참고 하실때 **언급 부탁드립니다.**
- 본 페이지는 100% 독립적으로 제작된 팬 메이드 시뮬레이터이며, PUBG 공식 웹 이벤트가 아닙니다.
- **KRAFTON, PUBG Corporation 또는 공식 파트너와 어떠한 제휴, 승인, 연관 관계도 없습니다.**
